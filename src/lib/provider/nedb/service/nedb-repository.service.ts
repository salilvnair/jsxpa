import { IJsxpaWriteRespository } from "../../../service/jsxpa-write-repository.service";
import { IJsxpaReadRespository } from "../../../service/jsxpa-read-repository.service";
...
export abstract class NeDBRepository<T>
  implements IJsxpaWriteRespository<T>, IJsxpaReadRespository<T> {
  ...
  private getDatabaseNameFromRepo() {
    let value: string = this.databaseName();
    if (value) {
